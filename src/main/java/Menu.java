...
public class Menu {
    ...
    void start(CsvToBean<Naixement> naixementCsvToBean) {
        ...
        while (!(menu.equals("0"))){
        System.out.println("1.  Naixements al barri del Poblenou");
        ...
        System.out.println("4.  Naixaments de mares nascudes a països que comencen per 'A'");
        ...
        switch(menu){
            ...
            case "4":
                llista.stream()
                        .filter(naixement -> naixement.getLloc_de_naixement().equals("A"))
                        .forEach(System.out::println);
                break;
